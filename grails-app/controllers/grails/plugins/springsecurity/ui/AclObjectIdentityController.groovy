...
class AclObjectIdentityController extends AbstractS2UiController {
	...
	protected String lookupClassName() {
		'org.codehaus.groovy.grails.plugins.springsecurity.acl.AclObjectIdentity'
	}
	...
	protected Class<?> lookupAclClassClass() {
		grailsApplication.getDomainClass('org.codehaus.groovy.grails.plugins.springsecurity.acl.AclClass').clazz
	}

	protected Class<?> lookupAclSidClass() {
		grailsApplication.getDomainClass('org.codehaus.groovy.grails.plugins.springsecurity.acl.AclSid').clazz
	}
}
